Public Class Form1
    ...
    Private Sub TampilData()
        ...
        If dgvData.Columns.Count > 0 Then
            ...
            dgvData.Columns("nama_website").HeaderText = "Nama Website"
            dgvData.Columns("url").HeaderText = "URL"
            dgvData.Columns("nama_kategori").HeaderText = "Kategori"
            dgvData.Columns("catatan").HeaderText = "Catatan"
